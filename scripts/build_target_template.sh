...
TARGET_LIB="${TARGET_LIB:-/path/to/libtarget.a}"
...
# CRITICAL: Rust owns the entrypoint. We must delete the C main symbol.
#
# +---------------------------------------------------------------+
# |                          WARNING                              |
# |  REMOVE main() FROM YOUR STATIC LIBRARY BEFORE LINKING         |
# |  ar d "${TARGET_LIB}" main.o                                   |
# +---------------------------------------------------------------+
#
# ar d "${TARGET_LIB}" main.o

# TODO: Copy libtarget.a and headers to a known location
# cp "${TARGET_LIB}" /path/to/ifb/target/lib/
